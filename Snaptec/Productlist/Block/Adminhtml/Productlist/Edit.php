...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    public function _construct()
    {
        ...
        if ($this->_isAllowedAction('Snaptec_Productlist::save')) {
        ...
        if ($this->_isAllowedAction('Snaptec_Productlist::productlist_delete')) {
    ...
    public function getHeaderText()
    {
        if ($this->coreRegistry->registry('productlist')->getId()) {
            return __(
                "Edit Productlist '%1'",
                $this->escapeHtml($this->coreRegistry->registry('productlist')->getListTitle())
            );
        } else {
    ...
    {
        $arrow_down_img = $this->getViewFileUrl('Snaptec_Productlist::images/arrow_down.png');
        $arrow_up_img   = $this->getViewFileUrl('Snaptec_Productlist::images/arrow_up.png');
        ...
        $productJsUpdateFunction = '
                    ...
                    function checkboxAllChecked(el){
                        ...
                        for (var i=1; i< product_grid_trs.length; i++) {
                            ...
                            if (e.id != "checkall_snaptecproductlist")
